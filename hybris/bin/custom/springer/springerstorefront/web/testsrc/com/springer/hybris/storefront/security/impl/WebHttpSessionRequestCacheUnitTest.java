...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/springerstorefront/electronics/en",
						"https://electronics.local:9002/springerstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/springerstorefront/electronics/en",
						"https://electronics.local:9002/springerstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/springerstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/springerstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/springerstorefront/electronics/en",
						"https://electronics.local:9002/springerstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/springerstorefront",
						"https://electronics.local:9002/springerstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/springerstorefront",
						"https://electronics.local:9002/springerstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/springerstorefront/electronics/en",
						"https://electronics.local:9002/springerstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
