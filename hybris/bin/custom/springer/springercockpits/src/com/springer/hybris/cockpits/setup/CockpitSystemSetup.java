 ...
 */
package com.springer.hybris.cockpits.setup;
...
import com.springer.hybris.cockpits.constants.SpringerCockpitsConstants;
 ...
 */
@SystemSetup(extension = SpringerCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(SpringerCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(SpringerCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						SpringerCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/springercockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
