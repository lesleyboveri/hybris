 ...
 */
package com.springer.hybris.initialdata.setup;
...
import com.springer.hybris.initialdata.constants.SpringerInitialDataConstants;
 ...
 */
@SystemSetup(extension = SpringerInitialDataConstants.EXTENSIONNAME)
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		...
		final ImportData macmillanImportData = new ImportData();
		macmillanImportData.setProductCatalogName(MACMILLAN);
		macmillanImportData.setContentCatalogNames(Arrays.asList(MACMILLAN));
		macmillanImportData.setStoreNames(Arrays.asList(MACMILLAN));
		importData.add(macmillanImportData);
