 ...
 */
package com.springer.hybris.test.setup;
...
import com.springer.hybris.test.constants.SpringerTestConstants;
import com.springer.hybris.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = SpringerTestConstants.EXTENSIONNAME)
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			else
			{
				...
				importImpexFile(context, "/springertest/import/qa-test-users.impex");

				LOG.info("Creating Reviews...");
				importImpexFile(context, "/springertest/import/reviews.impex");
				...
				importImpexFile(context, "/springertest/import/cstickets.impex");

				LOG.info("Creating Test Quotes...");
				importImpexFile(context, "/springertest/import/csquotes.impex");
			}
		}
	}
}
