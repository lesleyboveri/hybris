 ...
 */
package com.springer.hybris.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(SpringerFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(SpringerFulfilmentProcessConstants.PARENT_PROCESS);
