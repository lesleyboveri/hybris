 ...
 */
package com.springer.hybris.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, SpringerFulfilmentProcessConstants.PARENT_PROCESS);
