...
public class OrderExchangeRepairJobTest
{
	...
	public void cronJobTest()
	{
		...
		when(
				orderExchangeRepair.findAllProcessModelsToRepair(SpringersaporderfulfilmentConstants.ORDER_PROCESS_NAME,
						SendOrderToDataHubAction.ERROR_END_MESSAGE)).thenReturn(bpList);

		repairJob.perform(cronJobModel);
		verify(orderExchangeRepair).findAllProcessModelsToRepair(SpringersaporderfulfilmentConstants.ORDER_PROCESS_NAME,
