 ...
 */
package com.springer.hybris.saporderfulfillment.jalo;
...
/**
 * This is the extension manager of the Springersaporderfulfilment extension.
 */
public class SpringersaporderfulfilmentManager extends GeneratedSpringersaporderfulfilmentManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SpringersaporderfulfilmentManager.class.getName());
	 ...
	 */
	public static SpringersaporderfulfilmentManager getInstance()
	{
		return (SpringersaporderfulfilmentManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SpringersaporderfulfilmentConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SpringersaporderfulfilmentManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SpringersaporderfulfilmentManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SpringersaporderfulfilmentManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SpringersaporderfulfilmentManager called, current tenant: " + getTenant().getTenantID());
		}
	}
