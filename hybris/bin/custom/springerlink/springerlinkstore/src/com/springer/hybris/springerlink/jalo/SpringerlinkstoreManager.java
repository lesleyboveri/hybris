 ...
 */
package com.springer.hybris.springerlink.jalo;
...
/**
 * This is the extension manager of the Springerlinkstore extension.
 */
public class SpringerlinkstoreManager extends GeneratedSpringerlinkstoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SpringerlinkstoreManager.class);
	 ...
	 */
	public static SpringerlinkstoreManager getInstance()
	{
		return (SpringerlinkstoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SpringerlinkstoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SpringerlinkstoreManager() // NOPMD 
	{
		LOG.debug("constructor of SpringerlinkstoreManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SpringerlinkstoreManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SpringerlinkstoreManager called, current tenant: {}", getTenant().getTenantID());
	}
