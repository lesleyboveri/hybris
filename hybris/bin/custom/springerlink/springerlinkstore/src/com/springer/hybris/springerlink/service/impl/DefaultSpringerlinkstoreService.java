...
public class DefaultSpringerlinkstoreService implements SpringerlinkstoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSpringerlinkstoreService.class);
	...
	{
		return DefaultSpringerlinkstoreService.class.getResourceAsStream("/springerlinkstore/sap-hybris-platform.png");
	}
