 ...
 */
package com.springernature.hybris.checkout.jalo;
...
/**
 * This is the extension manager of the Springerlinkcheckoutservices extension.
 */
public class SpringerlinkcheckoutservicesManager extends GeneratedSpringerlinkcheckoutservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SpringerlinkcheckoutservicesManager.class);
	 ...
	 */
	public static SpringerlinkcheckoutservicesManager getInstance()
	{
		return (SpringerlinkcheckoutservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SpringerlinkcheckoutservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SpringerlinkcheckoutservicesManager() // NOPMD 
	{
		LOG.debug("constructor of SpringerlinkcheckoutservicesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SpringerlinkcheckoutservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SpringerlinkcheckoutservicesManager called, current tenant: {}", getTenant().getTenantID());
	}
