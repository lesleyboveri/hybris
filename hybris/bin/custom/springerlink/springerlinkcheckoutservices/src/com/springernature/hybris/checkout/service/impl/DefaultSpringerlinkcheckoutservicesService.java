...
public class DefaultSpringerlinkcheckoutservicesService implements SpringerlinkcheckoutservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSpringerlinkcheckoutservicesService.class);
	...
	{
		return DefaultSpringerlinkcheckoutservicesService.class.getResourceAsStream("/springerlinkcheckoutservices/sap-hybris-platform.png");
	}
