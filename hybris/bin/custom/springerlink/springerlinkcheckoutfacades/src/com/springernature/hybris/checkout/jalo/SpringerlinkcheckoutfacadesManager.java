...
/**
 * This is the extension manager of the Springerlinkcheckoutfacades extension.
 */
public class SpringerlinkcheckoutfacadesManager extends GeneratedSpringerlinkcheckoutfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SpringerlinkcheckoutfacadesManager.class);
	 ...
	 */
	public static SpringerlinkcheckoutfacadesManager getInstance()
	{
		return (SpringerlinkcheckoutfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SpringerlinkcheckoutfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SpringerlinkcheckoutfacadesManager() // NOPMD 
	{
		LOG.debug("constructor of SpringerlinkcheckoutfacadesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SpringerlinkcheckoutfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SpringerlinkcheckoutfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
