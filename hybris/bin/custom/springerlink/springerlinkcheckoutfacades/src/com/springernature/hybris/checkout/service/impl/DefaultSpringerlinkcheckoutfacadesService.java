...
public class DefaultSpringerlinkcheckoutfacadesService implements SpringerlinkcheckoutfacadesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSpringerlinkcheckoutfacadesService.class);
	...
	{
		return DefaultSpringerlinkcheckoutfacadesService.class.getResourceAsStream("/springerlinkcheckoutfacades/sap-hybris-platform.png");
	}
