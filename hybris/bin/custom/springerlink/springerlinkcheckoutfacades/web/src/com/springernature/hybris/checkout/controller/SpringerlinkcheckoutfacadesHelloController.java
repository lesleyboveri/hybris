...
@Controller
public class SpringerlinkcheckoutfacadesHelloController
{
	@Autowired
	...
	{
		model.addAttribute("logoUrl", springerlinkcheckoutfacadesService.getHybrisLogoUrl(PLATFORM_LOGO_CODE));
		return "welcome";
	}
}
