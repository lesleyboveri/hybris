 ...
 */
package com.springerlink.hybris.checkout.jalo;
...
import com.springerlink.hybris.checkout.constants.SpringerlinkcheckoutaddonConstants;



/**
 * This is the extension manager of the Springerlinkcheckoutaddon extension.
 */
public class SpringerlinkcheckoutaddonManager extends GeneratedSpringerlinkcheckoutaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SpringerlinkcheckoutaddonManager.class.getName());
	 ...
	 */
	public static SpringerlinkcheckoutaddonManager getInstance()
	{
		return (SpringerlinkcheckoutaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SpringerlinkcheckoutaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SpringerlinkcheckoutaddonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SpringerlinkcheckoutaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SpringerlinkcheckoutaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SpringerlinkcheckoutaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
