...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/macmillanstorefront/electronics/en",
						"https://electronics.local:9002/macmillanstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/macmillanstorefront/electronics/en",
						"https://electronics.local:9002/macmillanstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/macmillanstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/macmillanstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/macmillanstorefront/electronics/en",
						"https://electronics.local:9002/macmillanstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/macmillanstorefront",
						"https://electronics.local:9002/macmillanstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/macmillanstorefront",
						"https://electronics.local:9002/macmillanstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/macmillanstorefront/electronics/en",
						"https://electronics.local:9002/macmillanstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
