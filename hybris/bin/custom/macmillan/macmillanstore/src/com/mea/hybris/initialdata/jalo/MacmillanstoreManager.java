 ...
 */
package com.mea.hybris.initialdata.jalo;
...
/**
 * This is the extension manager of the Macmillanstore extension.
 */
public class MacmillanstoreManager extends GeneratedMacmillanstoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MacmillanstoreManager.class);
	 ...
	 */
	public static MacmillanstoreManager getInstance()
	{
		return (MacmillanstoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MacmillanstoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MacmillanstoreManager() // NOPMD 
	{
		LOG.debug("constructor of MacmillanstoreManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MacmillanstoreManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MacmillanstoreManager called, current tenant: {}", getTenant().getTenantID());
	}
