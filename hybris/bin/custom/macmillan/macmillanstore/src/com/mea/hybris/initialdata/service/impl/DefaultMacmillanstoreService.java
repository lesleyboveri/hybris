...
public class DefaultMacmillanstoreService implements MacmillanstoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMacmillanstoreService.class);
	...
	{
		return DefaultMacmillanstoreService.class.getResourceAsStream("/macmillanstore/sap-hybris-platform.png");
	}
