 ...
 */
package com.mea.hybris.fulfilmentprocess.test.jobs;
...
import com.mea.hybris.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = MacmillanfulfilmentprocessConstants.ORDER_PROCESS_NAME;
