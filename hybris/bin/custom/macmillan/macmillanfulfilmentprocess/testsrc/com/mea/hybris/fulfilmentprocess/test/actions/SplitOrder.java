 ...
 */
package com.mea.hybris.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(MacmillanfulfilmentprocessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MacmillanfulfilmentprocessConstants.PARENT_PROCESS);
