 ...
 */
package com.mea.hybris.macmillancore.jalo;
...
/**
 * This is the extension manager of the Macmillancore extension.
 */
public class MacmillancoreManager extends GeneratedMacmillancoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MacmillancoreManager.class);
	 ...
	 */
	public static MacmillancoreManager getInstance()
	{
		return (MacmillancoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MacmillancoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MacmillancoreManager() // NOPMD 
	{
		LOG.debug("constructor of MacmillancoreManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MacmillancoreManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MacmillancoreManager called, current tenant: {}", getTenant().getTenantID());
	}
