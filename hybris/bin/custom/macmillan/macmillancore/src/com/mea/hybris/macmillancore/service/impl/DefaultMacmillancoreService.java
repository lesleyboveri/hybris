...
public class DefaultMacmillancoreService implements MacmillancoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMacmillancoreService.class);
	...
	{
		return DefaultMacmillancoreService.class.getResourceAsStream("/macmillancore/sap-hybris-platform.png");
	}
