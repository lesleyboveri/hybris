...
<html>
<head>
    <title>Welcome to macmillanfacades</title>
    <link rel="stylesheet" href="<c:url value="/static/macmillanfacades-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "macmillanfacades" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/macmillanfacades-items.xml</b> - here you can model your items</li>
            <li><b>resources/macmillanfacades-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/macmillanfacades-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/macmillanfacades-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/macmillanfacades-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
