 ...
 */
package com.mea.hybris.facades.jalo;
...
/**
 * This is the extension manager of the Macmillanfacades extension.
 */
public class MacmillanfacadesManager extends GeneratedMacmillanfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MacmillanfacadesManager.class);
	 ...
	 */
	public static MacmillanfacadesManager getInstance()
	{
		return (MacmillanfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MacmillanfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MacmillanfacadesManager() // NOPMD 
	{
		LOG.debug("constructor of MacmillanfacadesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MacmillanfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MacmillanfacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
