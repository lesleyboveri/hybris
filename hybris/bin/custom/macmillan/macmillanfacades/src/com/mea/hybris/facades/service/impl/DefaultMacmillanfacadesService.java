...
public class DefaultMacmillanfacadesService implements MacmillanfacadesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMacmillanfacadesService.class);
	...
	{
		return DefaultMacmillanfacadesService.class.getResourceAsStream("/macmillanfacades/sap-hybris-platform.png");
	}
