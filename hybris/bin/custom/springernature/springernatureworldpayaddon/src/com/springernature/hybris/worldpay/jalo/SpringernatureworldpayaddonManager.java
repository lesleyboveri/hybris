 ...
 */
package com.springernature.hybris.worldpay.jalo;
...
import com.springernature.hybris.worldpay.constants.SpringernatureworldpayaddonConstants;



/**
 * This is the extension manager of the Springernatureworldpayaddon extension.
 */
public class SpringernatureworldpayaddonManager extends GeneratedSpringernatureworldpayaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SpringernatureworldpayaddonManager.class.getName());
	 ...
	 */
	public static SpringernatureworldpayaddonManager getInstance()
	{
		return (SpringernatureworldpayaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SpringernatureworldpayaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SpringernatureworldpayaddonManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SpringernatureworldpayaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SpringernatureworldpayaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SpringernatureworldpayaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
