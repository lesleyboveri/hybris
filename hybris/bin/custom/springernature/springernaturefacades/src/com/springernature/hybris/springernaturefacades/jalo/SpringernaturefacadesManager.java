 ...
 */
package com.springernature.hybris.springernaturefacades.jalo;
...
/**
 * This is the extension manager of the Springernaturefacades extension.
 */
public class SpringernaturefacadesManager extends GeneratedSpringernaturefacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SpringernaturefacadesManager.class);
	 ...
	 */
	public static SpringernaturefacadesManager getInstance()
	{
		return (SpringernaturefacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SpringernaturefacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SpringernaturefacadesManager() // NOPMD 
	{
		LOG.debug("constructor of SpringernaturefacadesManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SpringernaturefacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SpringernaturefacadesManager called, current tenant: {}", getTenant().getTenantID());
	}
