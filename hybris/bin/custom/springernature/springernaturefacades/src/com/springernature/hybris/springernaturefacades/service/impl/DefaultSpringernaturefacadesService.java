...
public class DefaultSpringernaturefacadesService implements SpringernaturefacadesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSpringernaturefacadesService.class);
	...
	{
		return DefaultSpringernaturefacadesService.class.getResourceAsStream("/springernaturefacades/sap-hybris-platform.png");
	}
