        ...
        <li class="item__list--item">
            ...
            <div class="item__menu">
                <c:if test="${entry.updateable}" >
                    <div class="btn-group">
                        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="editEntry_${loop.index}">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            <ycommerce:testId code="cart_product_removeProduct">
                                <c:choose>
                                    <c:when test="${not entry.product.multidimensional}" >
                                        <li class="js-remove-entry-button" id="removeEntry_${loop.index}">
                                            <a href="#"><spring:theme code="basket.page.remove"/></a>
                                        </li>
                                    </c:when>
                                    <c:otherwise>
                                        <li class="js-submit-remove-product-multi-d"  data-index="${loop.index}"  id="removeEntry_${loop.index}">
                                            <a href="#"><spring:theme code="basket.page.remove"/></a>
                                        </li>
                                    </c:otherwise>
                                </c:choose>
