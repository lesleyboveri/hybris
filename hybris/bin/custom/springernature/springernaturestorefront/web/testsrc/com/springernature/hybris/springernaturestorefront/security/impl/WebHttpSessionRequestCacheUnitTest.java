...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/springernaturestorefront/electronics/en",
						"https://electronics.local:9002/springernaturestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/springernaturestorefront/electronics/en",
						"https://electronics.local:9002/springernaturestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/springernaturestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/springernaturestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/springernaturestorefront/electronics/en",
						"https://electronics.local:9002/springernaturestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/springernaturestorefront",
						"https://electronics.local:9002/springernaturestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/springernaturestorefront",
						"https://electronics.local:9002/springernaturestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/springernaturestorefront/electronics/en",
						"https://electronics.local:9002/springernaturestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
