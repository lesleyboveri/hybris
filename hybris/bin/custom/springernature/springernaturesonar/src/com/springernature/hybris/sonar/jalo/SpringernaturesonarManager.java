 ...
 */
package com.springernature.hybris.sonar.jalo;
...
/**
 * This is the extension manager of the Springernaturesonar extension.
 */
public class SpringernaturesonarManager extends GeneratedSpringernaturesonarManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SpringernaturesonarManager.class);
	 ...
	 */
	public static SpringernaturesonarManager getInstance()
	{
		return (SpringernaturesonarManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SpringernaturesonarConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SpringernaturesonarManager() // NOPMD 
	{
		LOG.debug("constructor of SpringernaturesonarManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SpringernaturesonarManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SpringernaturesonarManager called, current tenant: {}", getTenant().getTenantID());
	}
