...
public class DefaultSpringernaturesonarService implements SpringernaturesonarService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSpringernaturesonarService.class);
	...
	{
		return DefaultSpringernaturesonarService.class.getResourceAsStream("/springernaturesonar/sap-hybris-platform.png");
	}
