 ...
 */
package com.springernature.hybris.springernaturebackoffice.jalo;
...
import com.springernature.hybris.springernaturebackoffice.constants.SpringernaturebackofficeConstants;
 ...
 */
public class SpringernaturebackofficeManager extends GeneratedSpringernaturebackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SpringernaturebackofficeManager.class.getName());
	 ...
	 */
	public static SpringernaturebackofficeManager getInstance()
	{
		return (SpringernaturebackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SpringernaturebackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SpringernaturebackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SpringernaturebackofficeManager called.");
		}
	}
