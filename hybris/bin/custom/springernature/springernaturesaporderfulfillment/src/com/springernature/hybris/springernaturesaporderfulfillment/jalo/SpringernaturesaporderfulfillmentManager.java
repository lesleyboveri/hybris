 ...
 */
package com.springernature.hybris.springernaturesaporderfulfillment.jalo;
...
/**
 * This is the extension manager of the Springernaturesaporderfulfillment extension.
 */
public class SpringernaturesaporderfulfillmentManager extends GeneratedSpringernaturesaporderfulfillmentManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SpringernaturesaporderfulfillmentManager.class.getName());
	 ...
	 */
	public static SpringernaturesaporderfulfillmentManager getInstance()
	{
		return (SpringernaturesaporderfulfillmentManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SpringernaturesaporderfulfillmentConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SpringernaturesaporderfulfillmentManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SpringernaturesaporderfulfillmentManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SpringernaturesaporderfulfillmentManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SpringernaturesaporderfulfillmentManager called, current tenant: " + getTenant().getTenantID());
		}
	}
