...
public class DefaultSpringernaturecoreService implements SpringernaturecoreService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSpringernaturecoreService.class);
	...
	{
		return DefaultSpringernaturecoreService.class.getResourceAsStream("/springernaturecore/sap-hybris-platform.png");
	}
