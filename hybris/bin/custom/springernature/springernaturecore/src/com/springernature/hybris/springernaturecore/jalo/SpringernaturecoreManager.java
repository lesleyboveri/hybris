 ...
 */
package com.springernature.hybris.springernaturecore.jalo;
...
/**
 * This is the extension manager of the Springernaturecore extension.
 */
public class SpringernaturecoreManager extends GeneratedSpringernaturecoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SpringernaturecoreManager.class);
	 ...
	 */
	public static SpringernaturecoreManager getInstance()
	{
		return (SpringernaturecoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SpringernaturecoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SpringernaturecoreManager() // NOPMD 
	{
		LOG.debug("constructor of SpringernaturecoreManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SpringernaturecoreManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SpringernaturecoreManager called, current tenant: {}", getTenant().getTenantID());
	}
