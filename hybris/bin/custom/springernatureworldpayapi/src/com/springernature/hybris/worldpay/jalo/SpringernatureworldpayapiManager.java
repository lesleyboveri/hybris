...
/**
 * This is the extension manager of the Springernatureworldpayapi extension.
 */
public class SpringernatureworldpayapiManager extends GeneratedSpringernatureworldpayapiManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SpringernatureworldpayapiManager.class);
	 ...
	 */
	public static SpringernatureworldpayapiManager getInstance()
	{
		return (SpringernatureworldpayapiManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SpringernatureworldpayapiConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SpringernatureworldpayapiManager() // NOPMD 
	{
		LOG.debug("constructor of SpringernatureworldpayapiManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SpringernatureworldpayapiManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SpringernatureworldpayapiManager called, current tenant: {}", getTenant().getTenantID());
	}
