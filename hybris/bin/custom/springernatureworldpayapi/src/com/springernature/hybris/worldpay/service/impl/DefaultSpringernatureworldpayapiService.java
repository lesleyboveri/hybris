...
public class DefaultSpringernatureworldpayapiService implements SpringernatureworldpayapiService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSpringernatureworldpayapiService.class);
	...
	{
		return DefaultSpringernatureworldpayapiService.class.getResourceAsStream("/springernatureworldpayapi/sap-hybris-platform.png");
	}
