 ...
 */
package com.springernature.hybris.assistedservice.jalo;
...
import com.springernature.hybris.assistedservice.constants.SpringernatureassistedservicestorefrontConstants;



/**
 * This is the extension manager of the Springernatureassistedservicestorefront extension.
 */
public class SpringernatureassistedservicestorefrontManager extends GeneratedSpringernatureassistedservicestorefrontManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SpringernatureassistedservicestorefrontManager.class.getName());
	 ...
	 */
	public static SpringernatureassistedservicestorefrontManager getInstance()
	{
		return (SpringernatureassistedservicestorefrontManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SpringernatureassistedservicestorefrontConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SpringernatureassistedservicestorefrontManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SpringernatureassistedservicestorefrontManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SpringernatureassistedservicestorefrontManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SpringernatureassistedservicestorefrontManager called, current tenant: " + getTenant().getTenantID());
		}
	}
